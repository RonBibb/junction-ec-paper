...
Please consider my manuscript, “A Strict Surface-Energy Obstruction for Timelike Kantowski–Sachs–Schwarzschild Junctions,” for publication in *General Relativity and Gravitation*. The manuscript proves that, in the \(F>0\) region outside the Schwarzschild horizon, every compatible finite-rapidity timelike junction between a homogeneous Kantowski–Sachs region and the retained asymptotically flat Schwarzschild exterior requires a thin shell with negative surface energy density, for either explicitly retained Kantowski–Sachs interval. For an exact static comoving family, the null energy condition additionally fails precisely outside the Schwarzschild photon sphere, with saturation at \(R_0=3m\), and an explicit Nariai product region supplies a local geometric witness.
