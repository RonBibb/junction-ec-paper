...
|---|---|
| `modules/junction-ec-paper-audit` | Executable symbolic derivations, numerical reproductions, claim matrix, and 35 unit tests. |
...
The verified 2026-08-09 linked-layout result is `JEC-A`, with JEC0–JEC8 passing and all 35 unit
tests passing.
